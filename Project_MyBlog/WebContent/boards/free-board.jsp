    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">자 유 게 시 판</li>
        </ol>

        <div class="card mb-3">
          <div class="card-header">
            <i class="fas fa-table"></i> 자 유 게 시 판 
          </div>

          <%-- 게시판 테이블 시작 --%>
          <jsp:include page="/boards/freeboard-table.jsp" />
          <%-- 게시판 테이블 종료 --%>
        ...
        <!-- 글쓰기 버튼 -->
          <div class="board-btns">
            <a class="btn btn-primary btn-board"
              href="<%=application.getContextPath()%>/boards/write-article.jsp?board_id=1">글쓰기</a>
          </div>
        <%
    	} else { //게스트 
