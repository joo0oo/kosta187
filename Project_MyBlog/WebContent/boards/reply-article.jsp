...
Article article= dao.read(article_id); //기존 게시글
String isReply= request.getParameter("isReply"); //기존 게시글이 답글형태인지 판별


String userID=null; //현재 사용자 
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">답글하기</li>
        </ol>
        ...
        <div class="card mb-3">
          ...
          <!-- 글쓰기 폼 -->
          <form action="/boards/reply-article-action.jsp" method="post">
          <div class="form-group">
            ...
            <input type="hidden" name="parent_id" value="<%= article.getArticle_id()%>">
            <input type="hidden" name="board_id" value="<%= article.getBoard_id()%>">
            <input type="hidden" name="ip" value="<%= request.getRemoteAddr() %>">
            <input type="hidden" name="isReply" value="<%=isReply%>"/>
            <button type="submit" class="btn btn-primary btn-board">답글쓰기</button>
