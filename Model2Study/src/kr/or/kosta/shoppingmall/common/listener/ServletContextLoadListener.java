...
public class ServletContextLoadListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent event)  {
		ServletContext servletContext = event.getServletContext(); //servlet context 생셩
		String serviceMapperLocation= servletContext.getInitParameter("serviceMapperLocation"); //web.xml에 등록된 파라미터 가져오기
		String daoMapperLocation= servletContext.getInitParameter("daoMapperLocation"); //web.xml에 등록된 파라미터 가져오기
		...
		System.out.println(" [debug] : serviceFactory, daoFactory 생성됨");
	}
