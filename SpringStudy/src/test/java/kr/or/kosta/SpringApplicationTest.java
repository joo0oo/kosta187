...
//	String[] configLocations = { "applicationContext.xml" };
	...
	public void setUp() throws Exception {
		 applicationContext = new GenericXmlApplicationContext(configLocation); //Spring 컨테이너 생성
	...
	public void test() {
		...
		// Chef chef = (Chef)applicationContext.getBean("chef"); //Object 리턴해서 형변환해줌
		Chef chef = applicationContext.getBean("chef", Chef.class); //이렇게 하면 형변환까지 된 채로 리턴
		...
		// 빈 검색
		boolean exist = applicationContext.containsBean("chef"); //존재여부
		logger.info(exist + "");
		...
		logger.info("chef : "+chef.hashCode());
		logger.info("chef2 : "+chef2.hashCode());
	}
}
