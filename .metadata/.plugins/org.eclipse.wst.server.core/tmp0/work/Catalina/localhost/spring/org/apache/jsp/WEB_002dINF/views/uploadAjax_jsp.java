 ...
 * Generated at: 2018-11-21 10:28:07 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\tvar formData= new FormData(); //ajax 파일 업로드\n");
      ...
      out.write("\t\t\t//formData에 파일 추가\n");
      out.write("\t\t\tformData.append('uploadFile',files[i]);\n");
      out.write("\t\t}\n");
      out.write("\t\t\n");
      out.write("\t\t\n");
      out.write("\t\t$.ajax({ //파일 전송 처리\n");
      out.write("\t\t\turl:'/spring/uploadAjaxAction',\n");
