...
public class RandomAccessFileExample {
	...
	public static void main(String[] args) throws IOException {
		...
		char[] messC=message.toCharArray();
		...
		System.out.println("boolean "+raf.getFilePointer());
		raf.writeChar(c);
		...
		System.out.println("String "+raf.getFilePointer());
		
		raf.writeChar(messC[0]);
		System.out.println(raf.getFilePointer());
		raf.writeChar(messC[5]);
		System.out.println(raf.getFilePointer());
		raf.writeChar(messC[10]);
		System.out.println(raf.getFilePointer());
		
		
		System.out.println("파일사이즈: " + raf.length()); //여태 쓴 byte수 출력됨
